...
/** Mock supplier for development/testing purposes */
@Slf4j
@Component
@RequiredArgsConstructor
@ConditionalOnProperty(name = "transfer.aggregator.mode", havingValue = "stub", matchIfMissing = true)
public class MockSupplierClient implements TransferSupplier {
    ...
    /** Returns 3 hardcoded offers(Standard Sedan, SUV, Executive Sedan) */
    @Override
    public SupplierSearchResult search(SearchCommand command, Duration timeout) {
        ...
        // Simulating latency as of real supplier
        sleep(500);
    ...
    /** Returns Mock Cancellation Confirmation */
    @Override
